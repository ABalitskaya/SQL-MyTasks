...
/* Сортировка: order by. Сперва сортируем по зарплате от большего к меньшему, потом по имени в алфавитном порядке
SELECT first_name, last_name, salary FROM hr.employees WHERE salary >= 10000 order by salary desk, first_name;*/

/*SELECT first_name, last_name, salary FROM hr.employees WHERE salary BETWEEN 5000 and 10000;*/

/* Оператор IN: выбрать все, где есть нужные значения*/
/*SELECT first_name, last_name FROM hr.employees WHERE first_name IN ("Steven", "Diana", "John", "Den");*/

/*SELECT first_name, last_name FROM hr.employees WHERE first_name LIKE "D%";*/

/*SELECT first_name, last_name FROM hr.employees WHERE last_name LIKE "___O%";*/

/*SELECT first_name, last_name FROM hr.employees WHERE department_id = 60 OR salary >= 10000;*/

/*SELECT first_name, last_name, salary FROM hr.employees WHERE department_id IN (100, 120, 30) AND salary > 10000;*/

/*SELECT first_name, last_name FROM employees WHERE first_name LIKE "K%";*/

/*SELECT first_name, last_name FROM employees WHERE first_name not LIKE "%o%";*/

/*SELECT first_name, last_name, salary FROM employees WHERE last_name LIKE "_o%" AND salary < 20000;*/

/*SELECT first_name, last_name, department_id, job_id FROM employees WHERE (first_name LIKE "K%" OR first_name LIKE "%a") AND job_id IN ("FI_ACCOUNT", "PU_CLERK", "ST_CLERK");*/

/*SELECT first_name, last_name, salary FROM employees order by salary desc;*/

/*SELECT first_name, last_name, salary FROM employees order by salary desc, last_name;*/

SELECT first_name, last_name, salary FROM employees WHERE salary BETWEEN 10000 and 20000 AND department_id IN (60,70,90,100) AND first_name LIKE "%a%" order by salary desc, last_name;
...
SELECT lower(concat_ws(' ', first_name, last_name)) AS full_name 
	FROM employees;
...
SELECT
	concat_ws(', ', country_id, city, street_address) as full_address
FROM locations;

SELECT
	length(concat_ws(', ', country_id, city, street_address)) as length
FROM locations;

SELECT (min_salary + max_salary)/2 as result
FROM jobs;

SELECT sqrt(min_salary * max_salary) as result FROM jobs;

SELECT round((max_salary / min_salary)*100) as result FROM jobs;

SELECT round(((max_salary - min_salary)/min_salary)*100) as result FROM jobs;
...
SELECT distinct commission_pct, salary FROM employees; /*выбирается уникальное сочетание значение*/
...
SELECT salary, 
		CASE 
			WHEN salary > 15000
            THEN concat(first_name, ' ', last_name, ' RICH')
            ELSE concat(first_name, last_name, ' NOT RICH')
            END
FROM employees;
...
SELECT
    CASE
  WHEN salary > 15000 THEN first_name
        ELSE '-'
    END as rich,
    CASE
  WHEN salary <= 15000 THEN first_name
